function Experience() {
    ...
    const tags = ['PHP', 'Python', 'JavaScript', 'MySQL', 'WordPress', 'React', 'Selenium']
            ...
            <div className="container">
                ...
                <div className="timeline">
                    <div className="timeline-item">
                        <div className="timeline-marker"><i className="fas fa-briefcase"></i></div>
                        <div className="timeline-content">
                            <div className="timeline-header">
                                <h3>ICT Coordinator & Software Developer</h3>
                                <span className="timeline-company">Chantilly Schools, Nairobi</span>
                                <span className="timeline-date">March 2019 – Present</span>
                            </div>
